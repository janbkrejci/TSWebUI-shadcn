...
export default function TextareaWidgetDemo() {
  ...
  const attributes: WidgetAttribute[] = [
    { name: "label", label: d.attrLabel, type: "string", defaultValue: d.textareaDefaultLabel },
    {
      name: "placeholder",
      label: d.attrPlaceholder,
      type: "string",
      defaultValue: d.textareaDefaultPlaceholder,
    },
  ...
  return (
    <WidgetDemoWrapper
      title={d.widgetTextareaTitle}
      description={d.widgetTextareaDescription}
      widgetType="textarea"
