...
function TsWindowDemo() {
  ...
  const openWelcomeWindow = React.useCallback(() => {
    ...
    openWindow(
      <div className="space-y-4">
        <p>
          This is content for <strong>Welcome Window</strong>.
        </p>
  ...
  const openDataWindow = () => {
    ...
    openWindow(
      <div className="space-y-4">
        <p>
          This is content for <strong>Data Viewer</strong>.
        </p>
  ...
  return (
    <div className="flex flex-col flex-1 gap-6 min-h-0 pb-6">
      ...
      <Tabs defaultValue="preview" className="flex-1 flex flex-col min-h-0">
        ...
        >
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>
                The <code>WindowProvider</code>, <code>WindowOutlet</code> and{" "}
                <code>useWindowManager</code> hook work together to provide a robust windowing
                system.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent
          value="documentation"
          className="flex-1 min-h-0 overflow-auto pt-4 data-[state=inactive]:hidden text-foreground"
        >
          <div className="space-y-8 pb-8 w-full">
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell className="font-mono text-xs font-semibold text-primary">
                        openWindow(content, options)
                      </TableCell>
                      <TableCell>
                        Opens a new window with the provided React content. If an <code>id</code> is
                        provided and already exists, the window is brought to front.
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-mono text-xs font-semibold text-primary">
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        Returns the <code>TsWindowRef</code> for the specified window, allowing
                        imperative control.
                      </TableCell>
                    </TableRow>
                    <TableRow>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Methods available on the window reference (retrieved via{" "}
                  <code>getWindow(id)</code>).
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        Adjusts the window height to match its content scroll height.
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-mono text-xs font-semibold text-primary">
                      ...
                      <TableCell>
                        Increments the window&apos;s Z-index to place it above others.
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Available props for configuring the window (passed as the second argument to{" "}
